...
import java.lang.Boolean;import java.lang.Integer;import java.lang.Override;import java.lang.String;import java.net.HttpURLConnection;
...
public class AsyncHttp extends AsyncTask<String, Integer, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        try {
            ...
            urlinput = "http://j11000.sangi01.net/cakephp/devices/add";
            postDataSample = "id="+this.id+"&name="+params[0]+"&serial="+params[1]+"&cpu_abi="+params[2]+"&model="+params[3]+"&release="+params[4]+"&sdk="+params[5];
